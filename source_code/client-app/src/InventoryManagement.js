...
function InventoryManagement() {
  ...
  const fetchData = async () => {
    const response = await fetch('http://ec2-3-133-144-19.us-east-2.compute.amazonaws.com/:3001/api/inventory');
  ...
  const handleUpdateItem = async (id) => {
    ...
    const response = await fetch(`http://ec2-3-133-144-19.us-east-2.compute.amazonaws.com:3001/api/inventory/${id}`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
